...
public final class RolesPoliciesServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "roles_policies.RolesPoliciesService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> getPaginateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Paginate",
      requestType = com.soustify.input.Input.PaginationRequest.class,
      responseType = com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> getPaginateMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest, com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> getPaginateMethod;
      ...
      synchronized (RolesPoliciesServiceGrpc.class) {
        if ((getPaginateMethod = RolesPoliciesServiceGrpc.getPaginateMethod) == null) {
          RolesPoliciesServiceGrpc.getPaginateMethod = getPaginateMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.PaginationRequest, com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest.class,
      responseType = com.soustify.output.Output.PersistenceDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest, com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;
    if ((getCreateMethod = RolesPoliciesServiceGrpc.getCreateMethod) == null) {
      synchronized (RolesPoliciesServiceGrpc.class) {
        if ((getCreateMethod = RolesPoliciesServiceGrpc.getCreateMethod) == null) {
          RolesPoliciesServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest, com.soustify.output.Output.PersistenceDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest,
      com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest, com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> getFindOneMethod;
  ...
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> getFindOneMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest, com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> getFindOneMethod;
      ...
      synchronized (RolesPoliciesServiceGrpc.class) {
        if ((getFindOneMethod = RolesPoliciesServiceGrpc.getFindOneMethod) == null) {
          RolesPoliciesServiceGrpc.getFindOneMethod = getFindOneMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.UUIDRequest, com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    default void paginate(com.soustify.input.Input.PaginationRequest request,
        io.grpc.stub.StreamObserver<com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest> create(
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
  ...
  public static final class RolesPoliciesServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest> create(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncClientStreamingCall(
  ...
  public static final class RolesPoliciesServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> paginate(
    ...
    /**
     */
    public com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse findOne(com.soustify.input.Input.UUIDRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RolesPoliciesServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse> findOne(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              com.soustify.roles_policies.RolesPolicies.RolesPoliciesResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.soustify.roles_policies.RolesPolicies.RolesPoliciesRequest,
