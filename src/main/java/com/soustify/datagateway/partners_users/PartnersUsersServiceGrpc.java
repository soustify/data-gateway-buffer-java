...
public final class PartnersUsersServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "soustify.datagateway.partners_users.PartnersUsersService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> getPaginateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Paginate",
      requestType = com.soustify.input.Input.PaginationRequest.class,
      responseType = com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> getPaginateMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest, com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> getPaginateMethod;
      ...
      synchronized (PartnersUsersServiceGrpc.class) {
        if ((getPaginateMethod = PartnersUsersServiceGrpc.getPaginateMethod) == null) {
          PartnersUsersServiceGrpc.getPaginateMethod = getPaginateMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.PaginationRequest, com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest.class,
      responseType = com.soustify.output.Output.PersistenceDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest, com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;
    if ((getCreateMethod = PartnersUsersServiceGrpc.getCreateMethod) == null) {
      synchronized (PartnersUsersServiceGrpc.class) {
        if ((getCreateMethod = PartnersUsersServiceGrpc.getCreateMethod) == null) {
          PartnersUsersServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest, com.soustify.output.Output.PersistenceDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest,
      com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest, com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> getFindOneMethod;
  ...
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> getFindOneMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest, com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> getFindOneMethod;
      ...
      synchronized (PartnersUsersServiceGrpc.class) {
        if ((getFindOneMethod = PartnersUsersServiceGrpc.getFindOneMethod) == null) {
          PartnersUsersServiceGrpc.getFindOneMethod = getFindOneMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.UUIDRequest, com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    default void paginate(com.soustify.input.Input.PaginationRequest request,
        io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest> create(
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
  ...
  public static final class PartnersUsersServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest> create(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncClientStreamingCall(
  ...
  public static final class PartnersUsersServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> paginate(
    ...
    /**
     */
    public com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse findOne(com.soustify.input.Input.UUIDRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PartnersUsersServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse> findOne(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.soustify.datagateway.partners_users.PartnersUsers.PartnersUsersRequest,
  ...
  private static abstract class PartnersUsersServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.soustify.datagateway.partners_users.PartnersUsers.getDescriptor();
    }
