...
public final class CustomersServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "soustify.datagateway.customers.CustomersService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.datagateway.customers.Customers.CustomersResponse> getPaginateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Paginate",
      requestType = com.soustify.input.Input.PaginationRequest.class,
      responseType = com.soustify.datagateway.customers.Customers.CustomersResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.datagateway.customers.Customers.CustomersResponse> getPaginateMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest, com.soustify.datagateway.customers.Customers.CustomersResponse> getPaginateMethod;
      ...
      synchronized (CustomersServiceGrpc.class) {
        if ((getPaginateMethod = CustomersServiceGrpc.getPaginateMethod) == null) {
          CustomersServiceGrpc.getPaginateMethod = getPaginateMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.PaginationRequest, com.soustify.datagateway.customers.Customers.CustomersResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.datagateway.customers.Customers.CustomersResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.datagateway.customers.Customers.CustomersRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = com.soustify.datagateway.customers.Customers.CustomersRequest.class,
      responseType = com.soustify.output.Output.PersistenceDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.datagateway.customers.Customers.CustomersRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.soustify.datagateway.customers.Customers.CustomersRequest, com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;
    if ((getCreateMethod = CustomersServiceGrpc.getCreateMethod) == null) {
      synchronized (CustomersServiceGrpc.class) {
        if ((getCreateMethod = CustomersServiceGrpc.getCreateMethod) == null) {
          CustomersServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<com.soustify.datagateway.customers.Customers.CustomersRequest, com.soustify.output.Output.PersistenceDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.datagateway.customers.Customers.CustomersRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<com.soustify.datagateway.customers.Customers.CustomersRequest,
      com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.soustify.datagateway.customers.Customers.CustomersRequest, com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.datagateway.customers.Customers.CustomersResponse> getFindOneMethod;
  ...
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.datagateway.customers.Customers.CustomersResponse> getFindOneMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest, com.soustify.datagateway.customers.Customers.CustomersResponse> getFindOneMethod;
    if ((getFindOneMethod = CustomersServiceGrpc.getFindOneMethod) == null) {
      synchronized (CustomersServiceGrpc.class) {
        if ((getFindOneMethod = CustomersServiceGrpc.getFindOneMethod) == null) {
          CustomersServiceGrpc.getFindOneMethod = getFindOneMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.UUIDRequest, com.soustify.datagateway.customers.Customers.CustomersResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    default void paginate(com.soustify.input.Input.PaginationRequest request,
        io.grpc.stub.StreamObserver<com.soustify.datagateway.customers.Customers.CustomersResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.datagateway.customers.Customers.CustomersRequest> create(
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.datagateway.customers.Customers.CustomersRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
  ...
  public static final class CustomersServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.datagateway.customers.Customers.CustomersRequest> create(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.datagateway.customers.Customers.CustomersRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncClientStreamingCall(
  ...
  public static final class CustomersServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.soustify.datagateway.customers.Customers.CustomersResponse> paginate(
    ...
    /**
     */
    public com.soustify.datagateway.customers.Customers.CustomersResponse findOne(com.soustify.input.Input.UUIDRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CustomersServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.soustify.datagateway.customers.Customers.CustomersResponse> findOne(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              com.soustify.datagateway.customers.Customers.CustomersResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.soustify.datagateway.customers.Customers.CustomersRequest,
  ...
  private static abstract class CustomersServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.soustify.datagateway.customers.Customers.getDescriptor();
    }
