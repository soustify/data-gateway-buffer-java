...
public final class PartnersContactsServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "soustify.datagateway.partners_contacts.PartnersContactsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> getPaginateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Paginate",
      requestType = com.soustify.input.Input.PaginationRequest.class,
      responseType = com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> getPaginateMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest, com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> getPaginateMethod;
      ...
      synchronized (PartnersContactsServiceGrpc.class) {
        if ((getPaginateMethod = PartnersContactsServiceGrpc.getPaginateMethod) == null) {
          PartnersContactsServiceGrpc.getPaginateMethod = getPaginateMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.PaginationRequest, com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest.class,
      responseType = com.soustify.output.Output.PersistenceDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest, com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;
      ...
      synchronized (PartnersContactsServiceGrpc.class) {
        if ((getCreateMethod = PartnersContactsServiceGrpc.getCreateMethod) == null) {
          PartnersContactsServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest, com.soustify.output.Output.PersistenceDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest,
      com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest, com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> getFindOneMethod;
  ...
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> getFindOneMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest, com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> getFindOneMethod;
      ...
      synchronized (PartnersContactsServiceGrpc.class) {
        if ((getFindOneMethod = PartnersContactsServiceGrpc.getFindOneMethod) == null) {
          PartnersContactsServiceGrpc.getFindOneMethod = getFindOneMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.UUIDRequest, com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    default void paginate(com.soustify.input.Input.PaginationRequest request,
        io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest> create(
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
  ...
  public static final class PartnersContactsServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest> create(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncClientStreamingCall(
  ...
  public static final class PartnersContactsServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> paginate(
    ...
    /**
     */
    public com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse findOne(com.soustify.input.Input.UUIDRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PartnersContactsServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse> findOne(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.soustify.datagateway.partners_contacts.PartnersContacts.PartnersContactsRequest,
  ...
  private static abstract class PartnersContactsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.soustify.datagateway.partners_contacts.PartnersContacts.getDescriptor();
    }
