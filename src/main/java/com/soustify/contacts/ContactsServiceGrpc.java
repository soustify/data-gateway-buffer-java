...
public final class ContactsServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "contacts.ContactsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.contacts.Contacts.ContactsResponse> getPaginateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Paginate",
      requestType = com.soustify.input.Input.PaginationRequest.class,
      responseType = com.soustify.contacts.Contacts.ContactsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest,
      com.soustify.contacts.Contacts.ContactsResponse> getPaginateMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.PaginationRequest, com.soustify.contacts.Contacts.ContactsResponse> getPaginateMethod;
      ...
      synchronized (ContactsServiceGrpc.class) {
        if ((getPaginateMethod = ContactsServiceGrpc.getPaginateMethod) == null) {
          ContactsServiceGrpc.getPaginateMethod = getPaginateMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.PaginationRequest, com.soustify.contacts.Contacts.ContactsResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.contacts.Contacts.ContactsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.contacts.Contacts.ContactsRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Create",
      requestType = com.soustify.contacts.Contacts.ContactsRequest.class,
      responseType = com.soustify.output.Output.PersistenceDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.soustify.contacts.Contacts.ContactsRequest,
      com.soustify.output.Output.PersistenceDataResponse> getCreateMethod() {
    io.grpc.MethodDescriptor<com.soustify.contacts.Contacts.ContactsRequest, com.soustify.output.Output.PersistenceDataResponse> getCreateMethod;
    if ((getCreateMethod = ContactsServiceGrpc.getCreateMethod) == null) {
      synchronized (ContactsServiceGrpc.class) {
        if ((getCreateMethod = ContactsServiceGrpc.getCreateMethod) == null) {
          ContactsServiceGrpc.getCreateMethod = getCreateMethod =
              io.grpc.MethodDescriptor.<com.soustify.contacts.Contacts.ContactsRequest, com.soustify.output.Output.PersistenceDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Create"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.soustify.contacts.Contacts.ContactsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static io.grpc.MethodDescriptor<com.soustify.contacts.Contacts.ContactsRequest,
      com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.soustify.contacts.Contacts.ContactsRequest, com.soustify.output.Output.PersistenceDataResponse> getUpdateMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.contacts.Contacts.ContactsResponse> getFindOneMethod;
  ...
  public static io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest,
      com.soustify.contacts.Contacts.ContactsResponse> getFindOneMethod() {
    io.grpc.MethodDescriptor<com.soustify.input.Input.UUIDRequest, com.soustify.contacts.Contacts.ContactsResponse> getFindOneMethod;
    if ((getFindOneMethod = ContactsServiceGrpc.getFindOneMethod) == null) {
      synchronized (ContactsServiceGrpc.class) {
        if ((getFindOneMethod = ContactsServiceGrpc.getFindOneMethod) == null) {
          ContactsServiceGrpc.getFindOneMethod = getFindOneMethod =
              io.grpc.MethodDescriptor.<com.soustify.input.Input.UUIDRequest, com.soustify.contacts.Contacts.ContactsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public interface AsyncService {
    ...
    default void paginate(com.soustify.input.Input.PaginationRequest request,
        io.grpc.stub.StreamObserver<com.soustify.contacts.Contacts.ContactsResponse> responseObserver) {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.contacts.Contacts.ContactsRequest> create(
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.soustify.contacts.Contacts.ContactsRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
  ...
  public static final class ContactsServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.contacts.Contacts.ContactsRequest> create(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.soustify.contacts.Contacts.ContactsRequest> update(
        io.grpc.stub.StreamObserver<com.soustify.output.Output.PersistenceDataResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncClientStreamingCall(
  ...
  public static final class ContactsServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.soustify.contacts.Contacts.ContactsResponse> paginate(
    ...
    /**
     */
    public com.soustify.contacts.Contacts.ContactsResponse findOne(com.soustify.input.Input.UUIDRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ContactsServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.soustify.contacts.Contacts.ContactsResponse> findOne(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              ...
              com.soustify.contacts.Contacts.ContactsResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.soustify.contacts.Contacts.ContactsRequest,
  ...
  private static abstract class ContactsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.soustify.contacts.Contacts.getDescriptor();
    }
